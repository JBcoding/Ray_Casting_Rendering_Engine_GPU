...
PRE_DEVICE bool RCRE_model3D_getIntersection(RCRE_model3D *m, RCRE_point3D *rayOrigin, RCRE_point3D *rayDirection, RCRE_point3D *outIntersectionPoint, RCRE_point3D *outReflectiveDirection, RCRE_point3D *outExitPoint, RCRE_point3D *outExitDirection);
PRE_DEVICE bool RCRE_model3D_getIntersectionPoint(RCRE_model3D *m, bool rayOriginatingOutside, RCRE_point3D *rayOrigin, RCRE_point3D *rayDirection, RCRE_point3D *outIntersectionPoint, RCRE_point3D *outReflectiveDirection, RCRE_point3D *outRefractionDirection);
