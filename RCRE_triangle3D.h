...
PRE_DEVICE bool RCRE_triangle3D_getIntersectionPoint(RCRE_triangle3D *t, RCRE_point3D *rayOrigin, RCRE_point3D *rayDirection, RCRE_point3D *outIntersectionPoint, RCRE_point3D *outReflectiveDirection);
