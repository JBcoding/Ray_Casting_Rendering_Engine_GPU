...
bool RCRE_model3D_getIntersection(RCRE_model3D *m, RCRE_point3D *rayOrigin, RCRE_point3D *rayDirection,
...
bool RCRE_model3D_getIntersectionPoint(RCRE_model3D *m, bool rayOriginatingOutside, RCRE_point3D *rayOrigin, RCRE_point3D *rayDirection,
